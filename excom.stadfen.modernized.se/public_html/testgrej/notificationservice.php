...
class IOSNotification
{
	...
	{
		$ST = $DB->prepare("DELETE FROM `IOSUsers` WHERE ID=? AND AccountID=?;");
	...
	public static function Send($deviceToken, $payload)
	{
		$apnsHost = 'gateway.sandbox.push.apple.com';//'gateway.push.apple.com';//'gateway.sandbox.push.apple.com';
		$apnsPort = 2195;
		...
		//stream_context_set_option($streamContext, 'ssl', 'passphrase', "Lell12345");
