...
{
	if(confirm("Är du säker på att du vill byta huvudkonto?"))
	{
...
function switchLock()
{
	...
	if(shallLock && !confirm("Är du säker på att du vill låsa denna kund?"))
		return;
	if(!$(button).modernizedButtonActive())
	{
...
?>
    ...
    <div style="">
    	<table class="list business-customers-list">
        	<tbody>
            	<tr><td class="bold">Virtuellt nummer:</td><td><span id="virtualnumber_span"><?php echo PhoneNumber::GetDisplayStyle($info['VirtualNumber']); ?></span> &nbsp;&nbsp;<a class="btn btn-default" href="javascript:editVirtualNumber();" role="button" id="button_vn">Ändra</a></td></tr>
