...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <div style="width: 100vw; height: 100vh; background:url(img/login-bg.jpg); background-size: cover;">
    	<div class="Absolute-Center" style="width: 270px; height: 400px;">
            <div style="width: 100%; height: 100%;padding: 0px 35px; background:#FFF; border: 1px solid #8B8B8B; border-radius: 4px; box-shadow: 0px 1px 3px rgba(0,0,0,0.35);">
                ...
                <div class="form-group">
                    <button class="btn btn-login" role="button" style="width: 100%; margin-top: 25px; padding-top: 15px; padding-bottom: 15px; font-size: 1em; text-transform: uppercase;" onClick="doSubmit();return false;">Logga in</button>
                </div>
                </form>
